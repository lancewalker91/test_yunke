...
if __name__ == '__main__':
    test_dir = r'C:\apache-tomcat-9.0.5\webapps\Jenkins\workspace\test_UI_yunke_online\test_yunke_UI_selenium'
    test_report = r'C:\apache-tomcat-9.0.5\webapps\Jenkins\workspace\test_UI_yunke_online\test_yunke_UI_selenium\HTML_report'
